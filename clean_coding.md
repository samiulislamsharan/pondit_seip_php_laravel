...
একটি function লেখা হল যার নাম দেয়া হল `add` এই function-টি কি কাজ করে বলে আপনার মনে হয়?

যোগ করা - তাই তো?

কিন্ত programmer-কে জিজ্ঞাসা করা হলে তিনি কিন্তু অন্য উত্তর দিলেন। তিনি বললেন, database-এ নতুন data সংযোজনের জন্য তিনি function-টি লিখেছেন। তার দিক থেকে ভেবে দেখলেও খুব একটা অসংগতি পাওয়া যাবে না। তাই এই সমস্যার সমাধান হল-নামকরনের ক্ষেত্রে এমন word পরিহার করতে হবে যার দ্বৈত অর্থ আছে।

একি class-এ যোগ করা এবং data সংযোজন করার জন্য দুটি function/method থাকলে যোগের function-টির নাম `add` রাখা হলে পরের টির নাম হতে পারে `insert` বা `append`. এক্ষেত্রে add নামটি পরিহার করাই বাঞ্ছনীয়।

### Use Solution Domain Name

আপনার করা code-এ যেহেতু পরবর্তীতে আর একজন programmer এসেই কাজ করবে, তাই নামকরণের ক্ষেত্রে ২ জনের field/domain-এর common term-গুলো ব্যাবহার করা উচিত। এক্ষেত্রে client বা problem domain-এর ব্যবহৃত specific term ন আনাই ভালো।

যেমন - আবহাওয়া অফিসে কোন বিশেষ উপাদান বিশ্লেষণ করার জন্য তৈরি করা প্রোগ্রাম পরবর্তীতে অন্য কোন programmer এসে পরিবর্তন করার প্রয়োজন হতে পারে। সেক্ষেত্রে `partsPerMillionCapture / ppmCapture` না লিখে `itemCapture` সহজে বোধগম্য হবে। তা বোঝার জন্য আবহাওয়া বিশেষজ্ঞের কাছে যাবার দরকার হবে না।

### Use Problem Domain Name

Code যদি এমন হয় যে সেটি পরবর্তীতে programmer-এর চাইতে client-ই বেশি ব্যাবহার করবে, তখন তার বোঝার সুবিধার জন্য Client domain-এর ব্যবহৃত term ব্যাবহার করে নাম দেয়া উচিত।

যেমন - একটি গার্মেন্টস ফ্যাক্টরিতে প্রতিদিনের কাজের হিসাব রাখার জন্য একটি প্রোগ্রাম লেখা হলো যেটি operate করবে ওই ফ্যাক্টরির নিয়োগকৃত কর্মচারী। তার বোঝার সুবিধার জন্য code-এ `count` না লিখে `noOfRoolProduced` লেখা বাঞ্ছনীয়।
